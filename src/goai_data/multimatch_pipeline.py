    ...
    def _parse_xa_rules(self, path: Path) -> dict[str, Any]:
        ...
        return {
            ...
            "parameters": {
                ...
                "long_loan": {"annual_rate": 0.12, "max_years": 4, "max_total_multiple_prior_equity": 3, "minimum_wan": 10},
                "short_loan": {"rate": 0.05},
                "receivable_discount": {"terms_1_2": 0.08, "terms_3_4": 0.09, "mode": "joint"},
                "factories": {
                    "大厂房": {"purchase_wan": 481, "rent_wan_per_year": 51, "capacity": 6, "score": 11},
                    "中厂房": {"purchase_wan": 248, "rent_wan_per_year": 31, "capacity": 3, "score": 6},
                    "小厂房": {"purchase_wan": 72, "rent_wan_per_year": 9, "capacity": 1, "score": 2},
                },
                "production_lines": {
                    "手工线": {"investment_wan": 40, "install_quarters": 0, "production_quarters": 2, "maintenance_wan_per_year": 15, "score": 5},
                    "自动线": {"investment_wan": 140, "install_quarters": 2, "production_quarters": 1, "maintenance_wan_per_year": 11, "score": 8},
                    "柔性线": {"investment_wan": 180, "install_quarters": 3, "production_quarters": 1, "maintenance_wan_per_year": 15, "score": 10},
                    "租赁线": {"investment_wan": 0, "install_quarters": 0, "production_quarters": 1, "maintenance_wan_per_year": 70, "score": 0},
                },
                "markets": {
