...
项目整体目标、当前数据与规则状态、已有模块关系和 Agent 后续阶段见：[GoAI 项目现状、目标与 Agent 实施路线图](docs/PROJECT_STATUS_AND_AGENT_PLAN.md)。
...
/home/undefined/Disk/python-envs/goai-py312/bin/goai-agent simulate \
  --team-id ZY02 \
  --actions-json examples/agent_actions.json
```
...
/home/undefined/Disk/python-envs/goai-py312/bin/goai-agent advise \
  --team-id ZY02 \
  --candidates-json examples/agent_candidates.json
```
...
/home/undefined/Disk/python-envs/goai-py312/bin/goai-agent state-simulate \
  --timeline-json examples/state_timeline.json
```
