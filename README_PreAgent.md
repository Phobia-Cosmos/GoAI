...
/home/undefined/Disk/python-envs/goai-py312/bin/goai-agent state-simulate \
  --state-json examples/production_ready_state.json \
  --timeline-json examples/production_delivery_timeline.json
```
...
/home/undefined/Disk/python-envs/goai-py312/bin/goai-agent compare-state-plans \
  --state-json examples/production_ready_state.json \
  --candidates-json examples/pre_agent_candidates.json
```
